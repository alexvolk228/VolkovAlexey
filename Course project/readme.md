...
4. Act (Улучшение) : При успешной работе системы (при сокращению временных затрат на обработку заказов), он внедряется в информационную систему предприятия, с возможностью доработки или расширения функционала в дальнейшем. 
