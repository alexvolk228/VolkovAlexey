...
С автоматической системой менеджер сможет обработать за смену = 320 заказов, что в 10 раза больше. А при суточном потоке в 100 заказов, с данной работой справится всего 1 менеджер.
